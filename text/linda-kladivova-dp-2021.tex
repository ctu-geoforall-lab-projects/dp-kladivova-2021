...
\begin{figure}[hbt!] 
\begin{center}
\includegraphics[width=14.5cm]{../pictures/open-source_software.png} 
...
V následující kapitole popíšeme možnosti usability testing, které úzce souvisí s dotazníky, které jsou hlavním rozhodovacím kritériem této práce.
...
<<<<<<< HEAD
in \ref{subsection:enhancing} GRASS modules can also be run through
=======
% ML: broken reference
in \ref{subsection:GIS software} GRASS modules can also be run through
>>>>>>> a7097f27b4bec8cb861940dff834a6a106954dde
