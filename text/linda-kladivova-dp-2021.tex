...
However, the author assumes the participation in these implementations 
...
% LK: added
WMS/WFS, put all GRASS into a single window, 
expand the set of management icons and also enrich even more
the Data Catalog.
