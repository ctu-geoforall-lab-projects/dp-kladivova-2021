...
the software and further work. The most useful feautes according to
...
location, and mapset, and for downloading location, and some or some
...
could speed up daily work with GRASS. The proposal compiled for the
second key question is not implemented in this work. However, the
author assumes the participattion in these implementations after the
completion of this work. Both the new first-time mode and the complete
removal of the old startup screen are planned improvements to the new
version of GRASS 8.0, which is scheduled for release in the spring of
2021.
