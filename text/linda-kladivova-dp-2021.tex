...
completely new possibilities have been added. GRASS GIS allows an user
% ML: add -> work/define (?)
...
\item \textbf{GRASS bypasses the startup screen and starts in the
  ...
  % ML: is "named after an user" correct wording?
...
work under an Unix operating system, GRASS GIS is usually run from the
