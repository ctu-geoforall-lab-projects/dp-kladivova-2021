...
\newpage \noindent Startup screens appear in some form in all selected
...
interaction with a first-time user is a completely general thing that
plays a role in all types of software.
...
(QGIS 3/ Matlab Simulink) and First Run Wizard (Zoner Photo Studio X) 
(see section \ref{subsection:enhancing}). Respondents
