...
\noindent The originally proposed text in the Info Bar in the third situation (see Figure \ref{fig:grass_infobar_2}) was changed according to the proposal of the respondent \#21 in Survey 2 Question 6. The Data tab after successful data import can be seen in Figures \ref{fig:lmgr3}, \ref{fig:mapdisplay3}.
