...
%% -------<<< Chapter 1: Theory and background information >>>-------\\%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item GRASS GIS launches in Startup screen if a mapset is not in a usable state (was deleted or is used by another process). In this special situation, GRASS starts in the same way as in version 7.8.
